...
public class TitleScreen extends Screen
{
    ...
    private void createNormalMenuOptions(int pY, int pRowHeight)
    {
        ...
        (this.addRenderableWidget(new Button(this.width / 2 - 100, pY + pRowHeight * 1, 200, 20, new TranslatableComponent("menu.multiplayer"), (p_314610_1_) ->
        {
    ...
    private void createDemoMenuOptions(int pY, int pRowHeight)
    {
        ...
        this.addRenderableWidget(new Button(this.width / 2 - 100, pY, 200, 20, new TranslatableComponent("menu.playdemo"), (p_314603_2_) ->
        {
            if (flag)
            {
        ...
        this.resetDemoButton = this.addRenderableWidget(new Button(this.width / 2 - 100, pY + pRowHeight * 1, 200, 20, new TranslatableComponent("menu.resetdemo"), (p_314601_1_) ->
        {
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        this.panorama.render(pPartialTicks, Mth.clamp(f, 0.0F, 1.0F));
        int i = 274;
        ...
        if ((l & -67108864) != 0)
        {
            ...
            {
                this.blitOutlineBlack(j, 30, (p_314606_2_, p_314606_3_) ->
                {
                    this.blit(pMatrixStack, p_314606_2_ + 0, p_314606_3_, 0, 0, 99, 44);
                    this.blit(pMatrixStack, p_314606_2_ + 99, p_314606_3_, 129, 0, 27, 44);
                    this.blit(pMatrixStack, p_314606_2_ + 99 + 26, p_314606_3_, 126, 0, 3, 44);
                    this.blit(pMatrixStack, p_314606_2_ + 99 + 26 + 3, p_314606_3_, 99, 0, 26, 44);
                    this.blit(pMatrixStack, p_314606_2_ + 155, p_314606_3_, 0, 45, 155, 44);
                });
            }
            else
            {
                ...
                {
                    this.blit(pMatrixStack, p_96766_2_ + 0, p_96766_3_, 0, 0, 155, 44);
                    this.blit(pMatrixStack, p_96766_2_ + 155, p_96766_3_, 0, 45, 155, 44);
                });
            }
            ...
            {
                Reflector.callVoid(Reflector.ForgeHooksClient_renderMainMenu, this, pMatrixStack, this.font, this.width, this.height, l);
            }

            if (this.splash != null)
            {
                pMatrixStack.pushPose();
                pMatrixStack.translate((double)(this.width / 2 + 90), 70.0D, 0.0D);
            ...
            if (Reflector.BrandingControl.exists())
            {
                if (Reflector.BrandingControl_forEachLine.exists())
                {
                    ...
                    {
                        drawString(pMatrixStack, this.font, brd, 2, this.height - (10 + brdline * (9 + 1)), 16777215 | l);
                    };
                ...
                if (Reflector.BrandingControl_forEachAboveCopyrightLine.exists())
                {
                    ...
                    {
                        drawString(pMatrixStack, this.font, brd, this.width - this.font.width(brd), this.height - (10 + (brdline + 1) * (9 + 1)), 16777215 | l);
                    };
            ...
            {
                drawString(pMatrixStack, this.font, s, 2, this.height - 10, 16777215 | l);
            }
        ...
        {
            this.modUpdateNotification.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
        }
    }
